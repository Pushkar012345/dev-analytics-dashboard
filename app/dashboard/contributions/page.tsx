      ...
      <div className="flex">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm mt-1">Your activity and commit trends</p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 mb-6">
            <h2 className="text-sm font-semibold text-gray-700 mb-4">Repo Activity — Last 6 Months</h2>
            <CommitChart data={monthlyData} />
          </div>

          {/* Day of week activity */}
          <div className="bg-white border border-gray-200 rounded-xl p-4 mb-6">
            <h2 className="text-sm font-semibold text-gray-700 mb-4">Most Active Days</h2>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            <h2 className="text-sm font-semibold text-gray-700 mb-4">Recently Updated Repos</h2>
                ...
                .map((repo: any) => {
                  ...
                  return (
                    <div key={repo.id} className="py-3 flex items-center justify-between">
                      <div>
                        <a href={repo.html_url} target="_blank" className="text-blue-600 text-sm font-medium hover:underline">{repo.name}</a>
                        <p className="text-xs text-gray-400 mt-0.5">{repo.description || 'No description'}</p>
                      </div>
                      <span className="text-xs text-gray-400">{days === 0 ? 'today' : `${days}d ago`}</span>
                    </div>
                  )
                })}
            </div>
