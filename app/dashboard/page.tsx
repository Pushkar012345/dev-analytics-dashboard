    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-gray-900">DevDash</span>
        </div>
        ...
        <div className="flex-1 p-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">@{user?.login} · {user?.location || 'GitHub Developer'}</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            <h2 className="text-sm font-semibold text-gray-700 mb-4">Top Repositories</h2>
                ...
                repos
                  ...
                  .map((repo: any) => (
                    <div key={repo.id} className="py-3 flex items-center justify-between">
                      <div>
                        <a href={repo.html_url} target="_blank" className="text-blue-600 font-medium text-sm hover:underline">
                          {repo.name}
                        </a>
                      ...
                      <div className="flex items-center gap-4 text-xs text-gray-500">
                        {repo.language && (
                          <span className="bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full">{repo.language}</span>
                        )}
